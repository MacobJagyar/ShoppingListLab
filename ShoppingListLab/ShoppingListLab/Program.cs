...
void RemoveItem()
{
    ...
    {
        Console.WriteLine("\nPlease enter a valid option. Press any key to retry.");
        Console.ReadKey();
        Console.Clear();
        RemoveItem();
    }
    ...
    if (groceryInput == 1)
    {
        if (shoppingList.Contains("Eggs") == true)
        {
            ...
            Console.Clear();
            Console.WriteLine("You removed eggs");
    ...
    else if (groceryInput == 2)
    {
        if (shoppingList.Contains("Bread") == true)
        {
            ...
            Console.Clear();
            Console.WriteLine("You removed bread");
    ...
    else if (groceryInput == 3)
    {
        if (shoppingList.Contains("Cheese") == true)
        {
            ...
            Console.Clear();
            Console.WriteLine("You removed cheese");
    ...
    else if (groceryInput == 4)
    {
        if (shoppingList.Contains("Butter") == true)
        {
            ...
            Console.Clear();
            Console.WriteLine("You removed butter");
    ...
    else if (groceryInput == 5)
    {
        if (shoppingList.Contains("Toothpaste") == true)
        {
            ...
            Console.Clear();
            Console.WriteLine("You removed toothpaste");
    ...
    else if (groceryInput == 6)
    {
        if (shoppingList.Contains("Laundry Detergent") == true)
        {
            ...
            Console.Clear();
            Console.WriteLine("You removed laundry detergent");
    ...
    else if (groceryInput == 7)
    {
        if (shoppingList.Contains("Shampoo") == true)
        {
            ...
            Console.Clear();
            Console.WriteLine("You removed shampoo");
    ...
    else if (groceryInput == 8)
    {
        if (shoppingList.Contains("Handsoap") == true)
        {
            ...
            Console.Clear();
            Console.WriteLine("You removed handsoap");
...
void AddRemoveCheck()
{
    ...
    while (addRemoveCheckInput > 3 || addRemoveCheckInput == 0)
    {
        Console.WriteLine("\nPlease enter a valid option. Press any key to retry.");
        Console.ReadKey();
        Console.Clear();
